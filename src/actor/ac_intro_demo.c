...
static void _none_aID_ACT_PROC(INTRO_DEMO_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aID_INIT_PROC(INTRO_DEMO_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
