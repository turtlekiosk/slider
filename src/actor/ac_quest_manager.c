...
static void _none_aQMgr_CHECK_LIMIT_PROC(QUEST_MANAGER_ACTOR* _p0, aQMgr_regist_c* _p1) { (void)_p0; (void)_p1; }
static void _none_aQMgr_CONTEST_SAVE_PROC(aQMgr_regist_c* _p0) { (void)_p0; }
static void _none_aQMgr_SAVE_PROC(aQMgr_regist_c* _p0) { (void)_p0; }
#endif

static aQMgr_CHECK_LIMIT_PROC l_errand_proc[mQst_ERRAND_NUM] = {
    _none_aQMgr_CHECK_LIMIT_PROC,
    _none_aQMgr_CHECK_LIMIT_PROC,
    _none_aQMgr_CHECK_LIMIT_PROC,
...
static void aQMgr_actor_clear_regist(aQMgr_regist_c* regist, int count) {
    for (count; count != 0; count--) {
        regist->check_limit_proc = _none_aQMgr_CHECK_LIMIT_PROC;
