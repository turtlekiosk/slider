...
static void _none_aHN0_TALK_PROC(HATUMODE_NPC0_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aHN0_THINK_INIT_PROC(HATUMODE_NPC0_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
