...
static void _none_aTNS_ACTION_PROC(NPC_SAO_TOOL_ACTOR* _p0) { (void)_p0; }
#endif

static void aTNS_setupAction(ACTOR* actorx, u8 action) {
    NPC_SAO_TOOL_ACTOR* npc_sao = (NPC_SAO_TOOL_ACTOR*)actorx;

    static aTNS_ACTION_PROC process[] = { _none_aTNS_ACTION_PROC, _none_aTNS_ACTION_PROC,
                                          _none_aTNS_ACTION_PROC, &aTNS_destruct,
                                          _none_aTNS_ACTION_PROC, NULL };
