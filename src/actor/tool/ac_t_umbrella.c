...
static void _none_UMBRELLA_PROC(ACTOR* _p0) { (void)_p0; }
#endif

void aTUMB_setupAction(UMBRELLA_ACTOR* umbrella, int action) {
    static UMBRELLA_PROC process[] = { aTUMB_takeout_before, _none_UMBRELLA_PROC, _none_UMBRELLA_PROC,
                                       aTUMB_destruct,       _none_UMBRELLA_PROC, NULL };
