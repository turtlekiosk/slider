...
static void _none_aNM2_INIT_PROC(NPC_MASK_CAT2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNM2_MOVE_PROC(ACTOR* _p0, GAME* _p1) { (void)_p0; (void)_p1; }
#endif
