...
static int _none_aNPC_TALK_END_CHECK_PROC(ACTOR* _p0, GAME* _p1) { (void)_p0; (void)_p1; return 0; }
static int _none_aNPC_TALK_INIT_PROC(ACTOR* _p0, GAME* _p1) { (void)_p0; (void)_p1; return 0; }
...
static void aNSO_actor_ct(ACTOR* actorx, GAME* game) {
    ...
    static aNPC_ct_data_c ct_data = {
        ...
        _none_aNPC_TALK_INIT_PROC,
        _none_aNPC_TALK_END_CHECK_PROC,
        1,
    };
