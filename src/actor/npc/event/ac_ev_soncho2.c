...
/* Typed stubs for (TYPE)&none_proc1 casts — wasm call_indirect requires
 * exact signature match. Generated by fix_none_proc1_casts.py. */
static void _none_aEV_SONCHO2_PROC(NPC_SONCHO2* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aEV_SONCHO2_TALK_PROC(NPC_SONCHO2* _p0, GAME* _p1) { (void)_p0; (void)_p1; }
#endif
