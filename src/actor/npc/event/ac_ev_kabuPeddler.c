...
static void _none_aEKPD_INIT_PROC(EV_KABUPEDDLER_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aEKPD_PROC(EV_KABUPEDDLER_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
