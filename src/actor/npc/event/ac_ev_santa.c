...
static void _none_aESNT_INIT_PROC(EVENT_SANTA_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aESNT_TALK_PROC(EVENT_SANTA_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
