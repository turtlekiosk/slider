...
static void _none_aEGPS_TALK_INIT_PROC(EV_GYPSY_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aEGPS_TALK_PROC(EV_GYPSY_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
