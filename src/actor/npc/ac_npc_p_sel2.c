...
static void _none_aNPS2_TALK_INIT_PROC(NPC_P_SEL2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNPS2_TALK_PROC(NPC_P_SEL2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
