...
static void _none_aNSC_ACTION_PROC(NPC_SHOP_COMMON_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNSC_INIT_PROC(NPC_SHOP_COMMON_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_mDemo_REQUEST_PROC(ACTOR* _p0) { (void)_p0; }
#endif
