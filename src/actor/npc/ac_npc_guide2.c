...
static void _none_aNG2_INIT_PROC(NPC_GUIDE2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNG2_PROC(NPC_GUIDE2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
