...
static void _none_aCR_ACT_PROC(NPC_CURATOR_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aCR_TALK_INIT_PROC(NPC_CURATOR_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
