...
static void _none_aSHM_TALK_PROC(NPC_SHOP_MASTERSP_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aSHM_THINK_PROC(NPC_SHOP_MASTERSP_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
