...
static void _none_aNRG_TALK_PROC(NPC_RCN_GUIDE_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNRG_THINK_INIT_PROC(NPC_RCN_GUIDE_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNRG_THINK_PROC(NPC_RCN_GUIDE_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
