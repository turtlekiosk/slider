...
static void _none_aNGD_INIT_PROC(NPC_GUIDE_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNGD_PROC(NPC_GUIDE_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
