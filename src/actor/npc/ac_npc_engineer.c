...
static void _none_aNPC_SCHEDULE_PROC(NPC_ACTOR* _p0, GAME_PLAY* _p1, int _p2) { (void)_p0; (void)_p1; (void)_p2; }
#endif
...
#else
        engineer->npc_class.schedule.schedule_proc = _none_aNPC_SCHEDULE_PROC;
#endif
