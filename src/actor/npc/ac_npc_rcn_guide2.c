...
static void _none_aNRG2_SET_STR_PROC(void) {  }
static void _none_aNRG2_TALK_PROC(NPC_RCN_GUIDE2_ACTOR* _p0) { (void)_p0; }
static void _none_aNRG2_THINK_INIT_PROC(NPC_RCN_GUIDE2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
static void _none_aNRG2_THINK_PROC(NPC_RCN_GUIDE2_ACTOR* _p0, GAME_PLAY* _p1) { (void)_p0; (void)_p1; }
#endif
