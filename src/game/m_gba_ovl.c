...
static void _none_mGB_OVL_PROC(Submenu* _p0, mSM_MenuInfo_c* _p1) { (void)_p0; (void)_p1; }
#endif

static void mGB_gba_ovl_move(Submenu* submenu) {
    static mGB_OVL_PROC ovl_move_proc[] = {
        &mGB_move_Move, &mGB_move_Play, &mGB_move_Wait, _none_mGB_OVL_PROC, &mGB_move_End,
    };
