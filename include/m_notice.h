...
extern void mNtc_SetInitData(void);
extern int mNtc_notice_write_num(void);
extern void mNtc_notice_write(mNtc_board_post_c* new_post);
extern void mNtc_auto_nwrite_time_ct(void);
extern void mNtc_set_auto_nwrite_data(void);
