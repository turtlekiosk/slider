...
extern u16 mEv_get_bargain_day(void);
extern u16 mEv_get_special_event_day(void);
extern u16 mEv_get_special_event_type(void);
extern int mEv_get_event_place(int event, int* bx, int* bz);
extern int mEv_bridge_time_check(void);
...
extern int mEv_get_rumor(void);
extern void mEv_actor_dying_message(int type, ACTOR* actor);
extern int mEv_LiveSonchoPresent(void);
...
extern void mGH_animal_return_init(void);
extern int mGH_check_birth2(void);
extern int mGH_check_birth(void);
extern void mGH_check_delete(void);
extern void mMC_mask_cat_init(void);
extern int mMC_check_birth(void);
extern int mMC_check_birth_day(void);
extern void mMC_check_delete(void);
extern void mMC_set_time(void);
