...
extern int mNpc_GetAnimalNum(void);
...
extern void mNpc_SetParentNameAllAnimal(void);
...
extern void mNpc_RenewalAnimalMemory(void);
...
extern void mNpc_Remail(void);
extern u8 mNpc_GetPaperType(void);
extern int mNpc_SendVtdayMail(void);
...
extern void mNpc_ClearEventNpc(void);
extern mNpc_EventNpc_c* mNpc_GetSameEventNpc(mActor_name_t event_id);
extern int mNpc_GetFreeMaskNpcIdx(void);
...
extern void mNpc_ClearMaskNpc(void);
...
extern void mNpc_MakeReservedListAfterFieldct(Anmhome_c* reserved, int reserved_num, u8* reserved_count, u8 bx_max,
                                              u8 bz_max);
extern void mNpc_InitNpcData(void);
...
extern Animal_c* mNpc_GetInAnimalP(void);
...
extern void mNpc_SendRegisteredGoodbyMail(void);
...
extern void mNpc_Grow(void);
extern void mNpc_ForceRemove(void);
...
extern void mNpc_ClearTalkInfo(void);
...
extern void mNpc_TalkInfoMove(void);
extern void mNpc_TalkEndMove(int animal_idx, int feel);
extern int mNpc_GetNpcFloorNo(void);
extern int mNpc_GetNpcWallNo(void);
...
extern void mNpc_SetNpcHomeYpos(void);
...
extern void mNpc_SetIslandGetFtrtoRoom(void);
extern void mNpc_SetIslandGetLetter(int get);
extern int mNpc_GetIslandGetLetter(void);
extern void mNpc_SetIslandCheckFtrMsg(int set);
extern int mNpc_GetIslandCheckFtrMsg(void);
extern void mNpc_ClearIslandNpcRoomData(void);
...
extern void mNpc_ClearIslandPresentFtrInfo(void);
extern void mNpc_SetIslandPresentFtr(void);
extern void mNpc_RestoreIslandPresentFtr(void);
extern int mNpc_GetIslandRoomFtrNum(void);
extern int mNpc_CheckIslandPresentFtrIs(void);
extern mActor_name_t mNpc_GetIslandPresentFtr(void);
extern PersonalID_c* mNpc_GetIslandPresentFtrPersonalID(void);
extern mActor_name_t mNpc_GetRandomBestFtr(void);
...
extern u32 mNpc_GetIslandMDIdx(void);
...
extern void mNpc_SendHPMail(void);
