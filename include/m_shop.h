...
extern int mSP_CountElementInGoodsList(void);
extern int mSP_CheckExchangeDay2(void);
extern int mSP_CheckExchangeMonth(void);
extern void mSP_NewExchangeDay(void);
...
extern void mSP_SetRenewalChiraswhi_AppoDay(void);
extern void mSP_ExchangeLineUp_InGame(GAME* game);
extern void mSP_PlusSales(u32 sum);
extern int mSP_SetNewVisitor(void);
extern u32 mSP_GetSalesSum(void);
extern int mSP_GetShopLevel(void);
extern int mSP_RenewShopLevel(void);
extern int mSP_GetRealShopLevel(void);
...
extern void mSP_ExchangeLineUp_ZeldaMalloc(void);
extern void mSP_LotteryLineUp_ZeldaMalloc(void);
extern void mSP_ExchangeLineUp_GameAlloc(GAME* game);
extern void mSP_LotteryLineUp_GameAlloc(GAME* game);
extern void mSP_InitShopSaveData(void);
extern void mSP_ShopGameStartCt(GAME* game);
extern mActor_name_t mSP_GetNowShopBgNum(void);
extern int mSP_WhatSpecialSale(void);
extern mActor_name_t mSP_GetNowShopFgNum(void);
extern lbRTC_hour_t mSP_GetShopOpenTime(void);
extern lbRTC_hour_t mSP_GetShopCloseTime(void);
extern lbRTC_hour_t mSP_GetShopCloseTime_Bgm(void);
extern int mSP_InRenewal(void);
extern int mSP_ShopOpen(void);
...
extern int mSP_Chk_HukubukuroSail(void);
extern int mSP_CheckFukubikiDay(void);
extern int mSP_SetGoods2ReservedPoint(mActor_name_t goods, mActor_name_t reserved_no);
extern int mSP_CheckHallowinDay(void);
extern void mSP_SetTanukiShopStatus(void);
...
extern void mSP_SelectRandomItemToAGB(void);
extern const char* mSP_ShopStatus2String(int status);
extern mActor_name_t mSP_GetRandomStationToyItemNo(void);
