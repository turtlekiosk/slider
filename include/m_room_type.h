...
extern u8* mRmTp_CheckFtrBirthInfoTop(void);
extern int mRmTp_GetFloorIdx(void);
extern int mRmTp_GetWallIdx(void);
...
extern void mRmTp_MakeMelodyData(void);
extern u8* mRmTp_GetMelodyData(void);
extern void mRmTp_DrawFamicomInfo(gfxprint_t* gfxprint);
extern void mRmTp_MakeFamicom_Fdebug(void);
...
extern int mRmTp_CheckWallIsMyOriginalInThisScene(void);
extern int mRmTp_CheckFloorIsMyOriginalInThisScene(void);
extern int mRmTp_GetEntranceBasePosition(xyz_t* pos);
extern int mRmTp_GetNowSceneLightSwitchIndex(void);
extern int mRmTp_PleaseDrawLightSwitch(void);
extern int mRmTp_NowSceneLightSwitchON(void);
extern int mRmTp_IndexLightSwitchON(int switch_index);
extern int mRmTp_NowSceneLightSwitchOFF(void);
...
extern void mRmTp_DecideCottageDefaultLightSwitch(void);
extern int mRmTp_GetNowSceneOriginalWallStatus(void);
extern int mRmTp_GetNowSceneOriginalFloorStatus(void);
